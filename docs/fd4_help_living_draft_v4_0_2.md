...
Choose **About FORDISC / Contributors** to open the current contributor roster. The order below is intentional and should be preserved:
...
Choose **Begin FORDISC** to enter the application. Within the application, the FORDISC logo in the upper-left corner acts as a home control: selecting it clears the current workspace and returns to the tier-appropriate default screen.
