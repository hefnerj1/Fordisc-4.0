...
Postcranial Measurement Entry uses the approved compact horizontal anatomical layout. One shared postcranial measurement record supports two **separate** analyses. The screen and header provide independent actions for **Run Postcranial DFA** and **Estimate Stature**.
